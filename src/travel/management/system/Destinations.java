...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"JW Mariott Hotel", "Mandarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "the BayClub Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel"};
